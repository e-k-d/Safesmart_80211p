...
bool TraCICommandInterface::subscribe(std::string vehicleId, std::string vehicleTypeId, std::string routeId, simtime_t emitTime_st, double emitPosition, double emitSpeed, int8_t emitLane)
{
    /*TraCIConnection::Result result;
    ...
    uint8_t variable3 = VAR_ARRIVED_VEHICLES_IDS;
