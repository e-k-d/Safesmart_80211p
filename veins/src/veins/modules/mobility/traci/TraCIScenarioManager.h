...
#define RSU0_PX 1559.0
#define RSU0_PY 766.0
#define RSU1_PX 1214.0
#define RSU1_PY 1066.0
#define RSU2_PX 909.0
#define RSU2_PY 1330.0
#define RSU3_PX 613.0
#define RSU3_PY 1559.0
#define RSU_PTHRESHOLD 60.0
#define VEHICLE_PTHRESHOLD 60.0
...
public:
    ...
    double safesmartSubscribe(std::string vehicleId);

    void processSafeSmartSubcriptionResult(TraCIBuffer& buf);
...
protected:
    ...
    int safetyMetric; // safety metric
    double EV_posx, EV_posy, EV_speed, EV_angle = 0.0, lowestInterTime = 99999.9999;
    ...
    void processVehicleContextSubscription(std::string objectId, TraCIBuffer& buf);
    bool inIntersection(double EV_posx, double EV_posy);
