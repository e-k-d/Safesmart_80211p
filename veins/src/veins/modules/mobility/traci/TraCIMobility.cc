...
void TraCIMobility::setIsEV(int isEV)
{
    //EV << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE" << std::endl;
    this->statistics.isEV = isEV;
}
