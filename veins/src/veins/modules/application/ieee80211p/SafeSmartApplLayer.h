...
#include "veins/modules/messages/VehicleBSM_m.h" //MONTIMERS
#include "veins/modules/messages/VehicleSRM_m.h" //MONTIMERS
#include "veins/modules/messages/RSUMap_m.h" //MONTIMERS
#include "veins/modules/messages/RSUSpat_m.h" //MONTIMERS
#include "veins/modules/messages/RSUSSM_m.h" //MONTIMERS
 ...
 * @see Decider80211p
 */
class VEINS_API SafeSmartApplLayer : public BaseApplLayer {

public:
    ~SafeSmartApplLayer() override;
...
protected:
    ...
    virtual void onBSM(VehicleBSM* bsm){};
...
protected:
    ...
    bool dataOnSch;
    simtime_t mapInterval;
    simtime_t spatInterval;
